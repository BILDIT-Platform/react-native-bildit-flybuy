...
If you have problem running the example app and has issue with React_Codegen; please run `./copy_codegen.sh`  to fix the issue. It looks like some of the library still refer to the old name.