...
install_xcframework "${PODS_ROOT}/../../../ios/Frameworks/FlyBuy.xcframework" "FlyBuy" "framework" "ios-arm64" "ios-x86_64-simulator"
install_xcframework "${PODS_ROOT}/../../../ios/Frameworks/FlyBuyPickup.xcframework" "FlyBuyPickup" "framework" "ios-arm64" "ios-x86_64-simulator"
install_xcframework "${PODS_ROOT}/../../../ios/Frameworks/FlyBuyNotify.xcframework" "FlyBuyNotify" "framework" "ios-x86_64-simulator" "ios-arm64"
install_xcframework "${PODS_ROOT}/../../../ios/Frameworks/FlyBuyPresence.xcframework" "FlyBuyPresence" "framework" "ios-arm64" "ios-x86_64-simulator"
